...
3. For Cursor:
   - Run this command in a terminal: `cursor --install-extension path/to/stata-mcp-0.1.1.vsix`
...
Starting with version 0.1.1, this extension integrates [uv](https://github.com/astral-sh/uv), a fast Python package installer built in Rust that significantly improves dependency installation speed.
